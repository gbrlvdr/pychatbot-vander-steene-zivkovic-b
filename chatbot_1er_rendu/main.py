...
print("Appuyer sur 5 pour indiquer le premier président à parler du climat et/ou de l’écologie (pas encore fini)\n", "Appuyer sur 6 pour afficher les mots que tous les présidents ont évoqués.")
...
while continuer!='n': 
    ...
    if action == 1:
        ...
        print("Nous n'avons pas terminé, désolé. En revanche la 6 fonctionne.")
    else:
